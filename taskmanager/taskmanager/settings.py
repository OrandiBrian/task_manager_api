...
SECRET_KEY = 'django-insecure-w0pm#a7pm^g7&$+)7nb94h)m3vp318q-2v1&of0*l6&=9&8f*m'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = ["brianorandi.pythonanywhere.com"]
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'tasks/static'),  # Ensure the path to your static folder is included
]
